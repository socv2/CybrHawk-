...
1. **Local Hosting Provider:**
   ...
   * CybrHawk or the Managed Service Provider (MSP) can manage the relationship with the local hosting provider for project management and support.
2. **Local Data Centre:**
   * Rent cabinet space in a local data centre.
   * Purchase hardware (5+ servers, network switches, firewalls).
   * CybrHawk takes full accountability and will project-manage, deploy and support the setup.
...
1. **Fully On-Premises:**
   * Requires extensive customer resources to manage infrastructure, making it the most costly option without additional benefits over Private SaaS.
2. **Private SaaS:**
