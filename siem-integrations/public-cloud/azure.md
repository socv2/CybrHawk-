...
To allow CybrHawk to assume an identity to start the scan with the required privileges, it is necessary to create a Service Principal. To create one, follow the next steps:

1. Access to Microsoft Entra ID
2. In the left menu bar, go to "App registrations."
3. Once there, in the menu bar, click on "+ New registration" to register a new application
4. Fill in the "Name, select the "Supported account types," and click on "Register. You will be redirected to the applications page.
...
5. In the Members tab, click on "+ Select members" and add the members you want to assign this role. In this case, the application was made in the first part.
...
5. In the "Baseline permissions" select "Start from JSON" and upload the file downloaded and modified in step 1.
