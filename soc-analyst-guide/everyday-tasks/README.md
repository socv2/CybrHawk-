...
| **SIEM Platform Only**  | Self-managed security operations. You retain full control of detection and response using our platform. | **Daily Triage** - Actively monitor and manage security alerts within the platform. |
...
_This document ensures clarity of roles and responsibilities, setting both our teams up for a successful security partnership._
